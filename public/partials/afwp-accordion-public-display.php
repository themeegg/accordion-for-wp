...
$radio_hash = md5( time() . rand( 1, 10000000 ) );
			...
			<ul class="afwp-accordion-list">
				<?php while ( $query->have_posts() ):$query->the_post(); ?>
					<li class="afwp-accordian-item-wrap">
						<input type="radio" id="afwp-radio-shortcode-<?php echo get_the_ID(); ?>"
						       name="afwp-radio-shortcode-accordion-<?php echo $radio_hash; ?>" checked="checked"/>
